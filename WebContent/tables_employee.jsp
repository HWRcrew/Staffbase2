  ...
  <center>
	 ...
	 %>
		...
		<div class="align_right">
    		<input id="button" name="new_employsee" type="button" value="Neuer Mitarbeiter" style="margin-right: 5px" onclick="location.href='<%=request.getContextPath()%>/EmployeeController?change='"/>
  		</div>
    <!-- end .content --></div>
  <!-- end .container --></div>
</body>
